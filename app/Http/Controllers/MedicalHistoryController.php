    ...
    public function getMedicalHistoryWithRelations($clientId)
{
    ...
    $medicalHistory = DB::table('medical_history')
        ...
        ->select(
            ...
            'clients.address',
            'clients.birthdate',
            'medical_history.cejas_od',
            'medical_history.cejas_oi',
            'medical_history.parpados_od',
            'medical_history.parpados_oi',
            'medical_history.pestanas_od',
            'medical_history.pestanas_oi',
            'medical_history.conjuntiva_od',
            'medical_history.conjuntiva_oi',
            'medical_history.aparato_lagrimal_od',
            'medical_history.aparato_lagrimal_oi',
